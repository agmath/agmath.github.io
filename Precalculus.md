...
|---------------|--------------|-------------|--------------|
| 1 | Introduction and What to Expect <br/> [Algebra Review, Part I](https://colab.research.google.com/drive/1Nvgi5nWn7jdNs-kuWfXwP4WdSn_2wL6F?usp=sharing) | [Class Slides](https://agmath.github.io/PreCalcWithLimits/Slide_Notes/D1_WhatToExpect.html){target="_blank"} | HW 1 |
