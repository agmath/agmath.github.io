...
<div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap;">
  ...
  <div style="display: flex; align-items: center; max-width: 75%;">
    ...
    <div>
      <p style="margin: 0;"><a href="https://drive.google.com/file/d/1T0mIZdOkO8RoJcdDEfw6GR39Ck2SRgPR/view?usp=sharing"><strong>Syllabus (Spring 2026)</strong></a></p>
...
|---------------|--------------|--------------|-------------|
| 1 | Review syllabus <br/> Create a GitHub account | [Course overview](https://agmath.github.io/BIGproblems/D1_OverviewSlides.html) <br/> Tentative: Meet your team and liaison <br/> Discuss project background | Set up your software environment <br/> (git, Python/R/Matlab, IDE of choice) |
...
| 3 | Continue project and approach research | [General software workflow basics](https://agmath.github.io/BIGproblems/ProjectPlanning_GitHub.html) <br/> Soft launch...issues, branches, merging | Assign basic initial issues <br/> branch and close with merges |
