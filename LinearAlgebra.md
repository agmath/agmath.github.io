...
<div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap;">
  ...
  <div style="display: flex; align-items: center; max-width: 60%;">
    <a href="https://agmath.github.io/Austin_ULA_Python/frontmatter.html"><img src="/SiteFiles/ula-cover.png" align="left" alt="Textbook Cover and Link" width="200" style="margin-right: 20px"></a>
    <div>
