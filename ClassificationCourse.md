...
| 4 |  | [EDA and `ggplot` Review](https://agmath.github.io/ClassificationCourse/x_DataViz_Primer.html) |  [EDA and Data Viz InClass](https://agmath.github.io/ClassificationCourse/Day4_EDA_and_Viz_Primer.html) | **Competition Assignment** -- Write a Statement of Purpose and conduct an Exploratory Data Analysis using our Zillow Price-Range Competition data. | 
