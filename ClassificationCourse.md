...
<img src="/SiteFiles/ISLR.png" align="left" width=200>[**Fall 2023 Syllabus**](https://drive.google.com/file/d/1W6sLmFZ0tkIPkqqo5nfSIusywC8R2zL-/view?usp=sharing)<br/>
<br/>
...
<br/>
***Note:*** Looking for a Python version of this course? I've got one! [Head over here](ClassificationCourse_Python.md) to see it. The Python version of the course is in its first iteration and I'm very interested in feedback. You can file issues directly to the [Course GitHub Repo](https://github.com/agmath/ClassificationCourse) or reach out to me directly.<br/>
<br/>
